...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] =
        ...
        { .pin = BSP_IO_PORT_00_PIN_08, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
          ...
          { .pin = BSP_IO_PORT_00_PIN_09, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
                  | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
          { .pin = BSP_IO_PORT_00_PIN_10, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN) },
          { .pin = BSP_IO_PORT_00_PIN_11, .pin_cfg = ((uint32_t) IOPORT_CFG_ANALOG_ENABLE) },
          { .pin = BSP_IO_PORT_00_PIN_12, .pin_cfg = ((uint32_t) IOPORT_CFG_ANALOG_ENABLE) },
          { .pin = BSP_IO_PORT_00_PIN_13, .pin_cfg = ((uint32_t) IOPORT_CFG_ANALOG_ENABLE) },
          ...
          { .pin = BSP_IO_PORT_01_PIN_00, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },
          { .pin = BSP_IO_PORT_01_PIN_01, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },
          { .pin = BSP_IO_PORT_01_PIN_02, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },
          { .pin = BSP_IO_PORT_01_PIN_03, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },
          { .pin = BSP_IO_PORT_01_PIN_08, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
                  | (uint32_t) IOPORT_PERIPHERAL_DEBUG) },
          { .pin = BSP_IO_PORT_01_PIN_09, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },
          { .pin = BSP_IO_PORT_01_PIN_10, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },
          { .pin = BSP_IO_PORT_01_PIN_12, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },
          ...
          { .pin = BSP_IO_PORT_04_PIN_07, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
                  | (uint32_t) IOPORT_PERIPHERAL_SAU1_OUT) },
          { .pin = BSP_IO_PORT_09_PIN_13, .pin_cfg = ((uint32_t) IOPORT_CFG_NMOS_ENABLE
                  | (uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
          { .pin = BSP_IO_PORT_09_PIN_14, .pin_cfg = ((uint32_t) IOPORT_CFG_NMOS_ENABLE
                  | (uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) }, };
